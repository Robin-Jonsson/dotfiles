...
"            | GROUP            | FG        | BG        | STYLE     |
"            --------------------------------------------------------
call s:SetHi("Normal",          s:Dark0,    s:Light0,   "none")
call s:SetHi("Comment",         s:Dark4,    "none",     "italic")
call s:SetHi("Statement",       s:Dark0,    "none",     "bold")
call s:SetHi("LineNr",          s:Light2,   "none",     "none")
call s:SetHi("CursorLineNr",    s:Accent3,  "none",     "bold")
" Bugfix
set cursorline
call s:SetHi("CursorLine",      "none",     "none",     "none")
call s:SetHi("String",          s:Dark3,    "none",     "none")
call s:SetHi("Special",         s:Dark0,    "none",     "bold")
call s:SetHi("Visual",          "none",     s:Light1,   "none")
call s:SetHi("PmenuSel",        "none",     s:Light2,   "bold")
call s:SetHi("Search",          "none",     s:Light2,   "none")
